...
export const Button = ({ children, disabled, to, type }) => {
  ...
  const styles = {
    ...
    secondary:
      'inline-block text-sm px-4 py-2.5 md:px-6 md:py-3.5 rounded-full bg-transparent border-2 border-stone-300 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-800 hover:text-stone-800 focus:bg-stone -300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed',
  };
  if (to)
    return (
